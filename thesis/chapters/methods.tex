...
\begin{figure}[tb]
    ...
    \caption{
        ...
        using the connection rule "fixed\_total\_number". (\textbf{B}) Mean number of synapses
...
Thus, the agreement between the numbers from the simulation and the theoretical expectation is quite
well. 
\begin{figure}[tb]
    \centering
