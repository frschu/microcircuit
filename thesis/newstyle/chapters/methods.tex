...
\begin{figure}[tb]
    ...
    \begin{subfigure}[b]{0.6\textwidth} 
        \includegraphics{../figures/diagram_colored_print.png}
        \label{fig:diagram}
    \end{subfigure}
...
different cortical regions (e.\,g. \citeb{boucsein2011beyond}). 
...
The procedure is based on one pursued by \citeb{sadeh2014mean}
...
With these parameters, we turn back to the self-consistency 
...
A solution to equation~\eqref{eq:self_consistency_a} is not necessarily found for any initial guess. 
